        ...
        <div>
            ...
            <div className={`br-tools-sidebar ${isSliderOpen ? 'open-tools' : ''}`}>
                <a onClick={toggleSlider} href="/" className="br-tools-sidebar-toggle in-out" style={{ backgroundColor: "whitesmoke" }}>
                    <img  style={{ width: "35px" }} src='assets/img/switcher/setting.svg' alt='switcher' />
                </a>
                    ...
                    isSliderOpen && (
                        <>
                            <div className="br-bar-title">
                                <h6>Tools</h6>
                                <div style={{ cursor: "pointer" }} onClick={closeSidebar} href="/" className="close-tools"><i className="fa-solid fa-xmark"></i></div>
                            </div>
